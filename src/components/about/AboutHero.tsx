...
export default function AboutHero() {
  return (
    <section className="relative h-[70vh] flex items-center justify-center overflow-hidden bg-[var(--background)]">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          Pelmes Signature, ev tipi makinelerle butik üretim yapan küçük ama tutkulu bir atölye.
        </motion.p>
      </div>
    </section>
  );
